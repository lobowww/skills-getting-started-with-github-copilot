...
activities = {
    ...
    "Soccer Team": {
        ...
        "schedule": "Practice: Mondays and Thursdays, 4:00 PM - 6:00 PM; Matches: Saturdays",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Recreational and competitive swimming training",
    ...
    "Debate Team": {
        "description": "Prepare for interschool debates and develop public speaking skills",
...
def unregister_participant(activity_name: str, email: str):
    """Unregister (remove) a student from an activity"""
    # Validate activity exists
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
